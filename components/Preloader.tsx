    ...
    return (
        <div className="preloader-container fixed inset-0 z-50 flex items-center justify-center bg-[#0B0B1A] text-white">
            <div className="flex flex-col items-center">
                ...
                <div className="text-7xl font-bold font-mono tracking-tighter text-transparent bg-clip-text bg-gradient-to-b from-white to-white/50 drop-shadow-[0_0_20px_rgba(255,255,255,0.05)]">
                    {progress}%
                </div>
                <div className="w-80 h-[2px] bg-white/10 mt-8 relative overflow-hidden">
                    <div
                        className="absolute top-0 left-0 h-full bg-gradient-to-r from-brand-cream to-white transition-all duration-300 ease-out shadow-[0_0_10px_rgba(255,255,255,0.1)]"
