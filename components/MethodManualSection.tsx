...
export default function MethodManualSection() {
    ...
    return (
        <div className="w-full max-w-6xl mx-auto px-4 md:px-6 h-full flex items-center justify-center">
            {/* Translucent dark backdrop for readability against bright video */}
            <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center bg-black/70 backdrop-blur-2xl border border-white/10 rounded-3xl p-6 md:p-10 shadow-[0_30px_80px_rgba(0,0,0,0.8)]">
                ...
                <div className="lg:col-span-5 flex justify-center items-center anim-child perspective-[1500px]">
                    <div className="relative group w-[220px] h-[300px] md:w-[260px] md:h-[360px] preserve-3d transition-transform duration-1000 ease-out hover:rotate-y-[-25deg] hover:rotate-x-[10deg] shadow-[0_30px_100px_rgba(255,255,255,0.02)] hover:shadow-[0_45px_120px_rgba(255,255,255,0.04)] rounded-r-xl">
                        ...
                        <div className="absolute inset-0 bg-gradient-to-br from-neutral-900 to-black rounded-r-xl border border-white/10 p-6 md:p-8 flex flex-col justify-between overflow-hidden shadow-[inset_0_0_40px_rgba(255,255,255,0.03)] select-none">
